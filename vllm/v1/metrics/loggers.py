...
class PrometheusStatLogger(AggregateStatLoggerBase):
    ...
    def __init__(
        ...
        counter_encoder_cache_queries = self._counter_cls(
            ...
            documentation=(
                "Encoder cache queries, in terms of number of queried items."
            ),
            labelnames=labelnames,
        )
        ...
        counter_encoder_cache_hits = self._counter_cls(
            ...
            documentation=(
                "Encoder cache hits, in terms of number of cached items."
            ),
            labelnames=labelnames,
        )
    ...
    def record(
        ...
        if scheduler_stats is not None:
            encoder_stats = scheduler_stats.encoder_cache_stats
            self.counter_encoder_cache_queries[engine_idx].inc(
                encoder_stats.queries)
            self.counter_encoder_cache_hits[engine_idx].inc(
                encoder_stats.hits)
